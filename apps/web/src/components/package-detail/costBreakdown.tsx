  ...
  return (
    <div>
        ...
        <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center">
            ...
            <span className="bg-slate-100 text-slate-500 text-[10px] font-bold px-3 py-1.5 rounded-full">Currency: {currency}</span>
        </div>
        ...
        <div className="bg-red-50/60 border border-red-100 rounded-xl px-3.5 py-2.5 flex items-start gap-2 text-[11px] text-red-800 leading-relaxed">
            ...
            <p>Prices are subject to exchange rate fluctuations. Last updated {updatedAt}.</p>
        </div>
        </div>
    </div>
  )
