      ...
      activities: [
        {
          ...
          description:
            'Deep dive into history and resilience. Guided audio tour is highly recommended for context.',
          cost: '$10 entry',
          location: 'Gisozi, Kigali',
          type: 'monument',
          aiPick: true,
          imageUrl:
            'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Kigali_genocide_memorial.jpg/400px-Kigali_genocide_memorial.jpg',
        },
        {
          id: 'act-1-2',
          time: '01:00 PM',
          ...
          description:
            'Famous for local dishes like Brochettes and Misuzu with a view over the city.',
          cost: '$15–20 est.',
          location: 'Kimihurura',
          type: 'food',
          imageUrl:
            'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=120&q=60',
        },
        {
          id: 'act-1-3',
          time: '07:00 PM',
          ...
          description:
            'Explore the vibrant Muslim quarter, finish with a traditional home-cooked meal.',
          cost: '$30 tour',
          location: 'Nyamirambo',
          type: 'tour',
          imageUrl:
            'https://images.unsplash.com/photo-1570168007204-dfb528c6958f?w=120&q=60',
        },
      ],
    },
    {
      ...
      activities: [
        {
          ...
          description:
            'Contemporary African art gallery run by two brothers. Vibrant paintings and live artists at work.',
          cost: 'Free entry',
          location: 'Kacyiru, Kigali',
          type: 'monument',
          imageUrl:
            'https://images.unsplash.com/photo-1531913764164-f85c52e6e654?w=120&q=60',
        },
        {
          id: 'act-2-2',
          time: '01:30 PM',
          ...
          description:
            'Authentic Rwandan buffet with banana beer, isombe, and grilled tilapia.',
          cost: '$12 est.',
          location: 'Remera',
          type: 'food',
          imageUrl:
            'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=120&q=60',
        },
      ],
    },
    {
      ...
      activities: [
        {
          ...
          description:
            'Guided canopy walk above the ancient rainforest. Book in advance — slots fill quickly.',
          cost: '$60 guided',
