  ...
  return (
    <section className="flex min-h-[120vh] w-full items-center overflow-hidden pt-10 sm:pt-14 md:min-h-[calc(100vh-64px)] lg:pt-0">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-3xl flex-col items-start justify-center px-5 pb-14 text-left md:px-8 lg:px-10">
        ...
        {/* Heading */}
        <h1 className="mb-6 max-w-[42rem] text-[3.1rem] font-semibold leading-[0.96] text-white drop-shadow-2xl sm:text-[3.8rem] md:text-[4.25rem] lg:text-[4.75rem]">
          Experience
        ...
        <p className="mb-9 max-w-[35rem] font-sans text-base font-light leading-relaxed text-white/95 drop-shadow-lg sm:text-[1.1rem] sm:pr-32">
          Join a community of explorers and book curated adventures through the
